-- Phase 0 follow-up: when public_price_mode=hide, omit servings from public taplist APIs.
-- hide → empty serving_options / null default_serving (not just null price).
-- show → return priced servings only.
