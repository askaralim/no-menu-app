-- In-bar /display: resolve brand for menu rows.
-- Prefer drinks.brand_name, then beer-profile brewery, then linked product brand/brewery.
-- (Many catalog rows leave brand_name null and only store brewery on drink_beer_profiles.)
