-- Keep drink log history intact when a source drink is archived, while allowing
-- clients to hide links that are no longer available through the public taplist.
