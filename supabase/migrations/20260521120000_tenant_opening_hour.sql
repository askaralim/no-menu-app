-- MVP: single daily opening hours as JSON on tenants

ALTER TABLE public.tenants
  ADD COLUMN IF NOT EXISTS opening_hour jsonb;

DROP FUNCTION IF EXISTS public.set_tenant_taplist_storefront(uuid, text, text, text, text, text);
...
GRANT EXECUTE ON FUNCTION public.set_tenant_taplist_storefront(uuid, text, text, text, text, text, jsonb) TO authenticated;
...
BEGIN
  ...
  SELECT
    ...
    t.district, t.address, t.opening_hour, t.cover_image_url, t.city, t.country,
