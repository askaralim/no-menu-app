-- Add street address to tenants for Tap List storefront + public RPCs

ALTER TABLE public.tenants
  ADD COLUMN IF NOT EXISTS address text;

DROP FUNCTION IF EXISTS public.set_tenant_taplist_storefront(uuid, text, text, text, text);
...
GRANT EXECUTE ON FUNCTION public.set_tenant_taplist_storefront(uuid, text, text, text, text, text) TO authenticated;
...
BEGIN
  ...
  SELECT
    ...
    t.district, t.address, t.cover_image_url, t.city, t.country,
