...
--
-- Beers:
--   1) 裂变酿造 | 春季拉格 | Spring Lager | 5.2
--   2) 裂变酿造 | Nebula Nectar | DDH India Pale Ale | 6.8
--
-- Notes:
...
menu_rows AS (
  ...
  FROM (
    VALUES
      (1, '裂变酿造'::text, '春季拉格'::text, 'Spring Lager'::text, 5.2::numeric),
      (2, '裂变酿造'::text, 'Nebula Nectar'::text, 'DDH India Pale Ale'::text, 6.8::numeric)
